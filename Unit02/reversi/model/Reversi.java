...
public class Reversi {
    ...
    /**
     * The {@link SquareColor} of the current player.
     */
    private SquareColor turn;
    ...
    public void start() {
        ...
        try {
            ...
            board[3][3].occupy(SquareColor.BLACK);
            board[3][4].occupy(SquareColor.WHITE);
            board[4][3].occupy(SquareColor.WHITE);
            board[4][4].occupy(SquareColor.BLACK);
    ...
    /**
     * Attempts to play a piece of the current player's {@link SquareColor} on the
    ...
    /**
     * Returns the {@link SquareColor} of the current player.
     *
     * @return The {@link SquareColor} of the current player.
     */
    ...
    private List<Square> searchDir(int row, int col, Direction d ) {
        ...
        for(int r=row+d.getRowMod(), c=col+d.getColMod();
            ...
            SquareColor color = square.getOccupyingColor();
            if (color == SquareColor.EMPTY) {
                squares.clear();
                return squares;
